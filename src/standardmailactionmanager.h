...
public:
     ...
     * will be disabled.
     *
     * \a selectionModel selection model for collections
     */
     ...
     *
     * \a type action type
     * \a text localized text for action
     */
     ...
     * will be disabled.
     *
     * \a favoritesModel model for a user's favorite mail collections
     */
     ...
     *
     * \a selection model for favorite collections
     */
