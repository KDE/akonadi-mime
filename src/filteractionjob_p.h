...
/*!
 * \brief Job to filter and apply an action on a set of items.
 *
...
public:
     ...
     *
     * \a item The item to act on. The item is not re-fetched.
     * \a functor The FilterAction to use.
     ...
     *
     * \a items The items to act on. The items are not re-fetched.
     * \a functor The FilterAction to use.
     * \a parent The parent object.
     */
     ...
     *
     * \a collection The collection to act on.
